...
CLUSTER_HOSTNAME_0="`cat /etc/hosts | grep etcd-0 | awk '{ printf $1 "\n"}'`"
CLUSTER_HOSTNAME_1="`cat /etc/hosts | grep etcd-1 | awk '{ printf $1 "\n"}'`"
CLUSTER_HOSTNAME_2="`cat /etc/hosts | grep etcd-2 | awk '{ printf $1 "\n"}'`"
